...
struct ImDrawList
{
    ...
    IMGUI_API ImDrawList* CloneOutput() const;                                  // New a clone of the CmdBuffer/IdxBuffer/VtxBuffer.
...
struct ImGuiPlatformIO
{
    ...
    void    (*Platform_CreateWindow)(ImGuiViewport* vp);                    // . . U . .  // New a new platform window for the given viewport
    ...
    void    (*Renderer_CreateWindow)(ImGuiViewport* vp);                    // . . U . .  // New swap chain, frame buffers etc. (called after Platform_CreateWindow)
